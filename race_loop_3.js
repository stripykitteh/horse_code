...
csv = '/Users/phillipmonk/research_paper/data/races_horses_diffs.csv'
...
for (let race_no = arg[0]; race_no < arg[1]; race_no++) {
	...
	var race_arr = races[race_no].split('_');
	race_stub = race_arr[3] + '/' + race_arr[4] + '/race/' + race_arr[6].split('.')[0];
	...
	fs.writeFile('/Users/phillipmonk/research_paper/html/races_3/racing_com_form_' + race_stub_under + '.html', html, err => {
	    if (err) {
		console.error(err);
	    }
