...
//
// e.g., for jockey Chris Waller, these would be:
// 
// * https://www.racing.com/trainer/chris-waller/form
// * https://www.racing.com/trainer/chris-waller/stats
//
...
function slurp_trainer(sub_page) {
	...
	(async () => { 
	    ...
	    trainer_stub = trainer_arr[0] + "/" + sub_page;
	    ...
	    fs.writeFile('/Users/phillipmonk/research_paper/html/trainers_final/racing_com_trainers_' + trainer_stub_under + '.html', html, err => {
		if (err) {
		    console.error(err);
		}
