...
csv = '/Users/phillipmonk/research_paper/data/races_2.csv'
...
for (let race_no = arg[0]; race_no < arg[1]; race_no++) {
	...
	fs.writeFile('/Users/phillipmonk/research_paper/html/races_2/racing_com_form_' + race_stub_under + '.html', html, err => {
	    if (err) {
		console.error(err);
	    }
