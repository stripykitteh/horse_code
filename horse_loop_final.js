...
csv = '/Users/phillipmonk/research_paper/horse_code/data/horses_final.csv'
...
for (let horse_no = arg[0]; horse_no < arg[1]; horse_no++) {
	...
	fs.writeFile('/Users/phillipmonk/research_paper/html/horses_final/racing_com_horses_' + horse_stub_under + '.html', html, err => {
	    if (err) {
		console.error(err);
	    }
